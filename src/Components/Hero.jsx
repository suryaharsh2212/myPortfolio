            ...
            <div className="w-screen h-screen flex flex-col lg:flex-row justify-center items-center bg-white">
                ...
                >
                    ...
                    <div className="flex w-full ">
                        <a className=" rounded-md  bg-sky-600 text-white px-5 h-10 md:ml-20 mt-5 flex justify-center items-center"  href="/surya_resume.pdf" target="_blank" rel="noopener noreferrer" >Resume </a>
